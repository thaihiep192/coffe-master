...
<body>
    <div class="wrapper">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <img src="uploads/<?php $filepath_dir = "uploads/";
                                                        $filepath_file = $filepath_dir.$s_image;
                                                        echo "<br><img src='".$filepath_file."'width = '300'>";
                                                        ?>>
                                </div> 
        ...
        <footer class="main-footer">         
            <strong>
                DEVELOPER
                <a href="https://www.facebook.com/hiep.nguyenthai.921/" style="text-decoration: none; color: #19B3D3;">Nguyễn Thái Hiệp</a>
                .
            </strong>    
        </footer>
    </div>
